# Programa que leia a largura e a algura de uma parede em metros e calcule a sua área e a quantidade de tinta necessária para pintá-la.
# Sabendo que cada litro de tinta pinta uma área de 2m²

largura = float(input("Digite a largura: \n"))
altura = float(input("Digite a altura: \n"))
area = largura * altura
print("Sua parede tem a dimensão {}x{} e sua área é de {}m².".format(
    largura, altura, area))
